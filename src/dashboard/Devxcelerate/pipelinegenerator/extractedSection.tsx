...
const ExtractedSections: React.FC<Props> = ({ responseText }) => {
  ...
  //         <div
  //           key={index}
  //           className="bg-[black] whitespace-pre-wrap break-words text-white p-4 rounded-lg shadow-md space-y-2 "
  //         >
  ...
  <div className="space-y-6 w-full">
    {rawSections.map((section, index) => {
      ...
      return (
        <div
          key={index}
          className="bg-[black] text-white p-3 rounded-lg shadow-md space-y-2
